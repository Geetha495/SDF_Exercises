...
[10](https://github.com/Geetha495/SDF_Exercises/tree/main/Ex10). Implement a template adapter class stack which uses [(1)](https://github.com/Geetha495/SDF_Exercises/blob/main/Ex10/array.cpp) an std::list (2) an std::array.
